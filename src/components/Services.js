    ...
    <div className="bg-[#f7f7f7] relative">
      <div className="container mx-auto md:py-40 py-20 sm:px-0  px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-10 gap-4 xl:px-24 lg:px-10 pt-20 ">
          <div>
            <Image src={smain} width={630} height={416} alt="about " className="w-full" />
          </div>
          ...
          <div className="">
            ...
            <span className="flex sm:gap-4 gap-2 items-center sm:text-lg text-base sm:py-4 py-3 font-medium">
            ...
            <span className="flex sm:gap-4 gap-2 items-center sm:text-lg text-base pb-10 font-medium">
              <IoCheckmark className="border rounded-full bg-[#dac79f] text-[#b48e40] 
              xs:w-7 xs:h-7 w-5 h-5"
              />
